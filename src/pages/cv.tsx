  ...
  return (
    <main className={styles.cv}>
      <div className={styles.info}>
        ...
        <div className={styles.baseInfo}>
          ...
          <div className={styles.contact}>
            <p>simonfisher227@gmail.com | 上海</p>
          </div>
      ...
      <CollapseContent title='个人简介'>
        教育技术学硕士毕业，在教育公司从事教学设计、产品运营等工作。之后自学前端开发相关知识，目前从事前端开发，参与过后台管理系统、H5小游戏、移动端H5等类型应用的开发。
      </CollapseContent>
        ...
        <section className={styles.expContainer}>
          ...
          <div className={styles.expDes}>
            ...
            <section className={styles.jobDes}>
              ...
              <p>我的角色：为中途接手项目，接手时项目已有完善的基础架构（权限管理、动态路由、通用业务组件等），了解基础架构后，我继续进行业务页面的开发，直至项目上线。</p>
            ...
            <section className={styles.jobDes}>
              ...
              <p>我的角色：调研与独立开发H5小游戏：前期花了4天调研 Egret 系列工具（引擎API、龙骨动画制作工具），开发周期内与产品经理沟通需求，设计小游戏状态、资源、视图的管理，完成3个小游戏开发与部署。期间对 Egret 引擎Api、DragonBone 龙骨动画有较多使用。</p>
            ...
            <section className={styles.jobDes}>
              ...
              <p>我的角色：独立负责该项目的设计、开发与上线：前期与产品沟通项目需求，根据需求设计项目文件结构，做了一些基础封装（网络请求、通用业务组件等），在此基础上开发了两个业务模块，并上线交付。</p>
      ...
      <CollapseContent title='教育经历'>
        <section className={styles.expContainer}>
          <header className={styles.expHeaderWithFlex}>
            ...
            <Image
              src="/jiangnan_university_logo.png" alt="jiangnan_university_logo"
              width={80}
              height={80}
            />
          </header>
